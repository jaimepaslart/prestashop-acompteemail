{**
 * Override theme enfant - personal-information.tpl
 * Ajout du hook displayPersonalInformationBottom pour le module LCB-FT
 *}
...
{block name='step_content'}
  {if $customer.is_logged && !$customer.is_guest}
    ...
    {* Hook LCB-FT - Formulaire en bas de l'etape Informations personnelles *}
    {hook h='displayPersonalInformationBottom' customer=$customer}
